      ...
      <div className="row gy-4 justify-content-center">
        ...
        <div className="col-lg-8 content">
          ...
          <p className="py-3 justify">
            Being a MERN Stack Developer means turning abstract ideas into
          ...
          <div className="row">
            {[
              ...
              { label: "Email", value: "avinashgangapatruni27@gmail.com" },
              { label: "Website", value: "https://mywebsite.com" },
              { label: "Address", value: "kakinada, Andhra Pradesh, India" },
            ].map((item, index) => (
